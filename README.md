...
[![Maven Central](https://img.shields.io/badge/Maven_Central-3.0.2-blue?logo=apachemaven)](https://central.sonatype.com/artifact/trade.invision/num)
[![Javadoc](https://img.shields.io/badge/javadoc-3.0.2-brightgreen)](https://javadoc.io/doc/trade.invision/num)
...
```kotlin
implementation("trade.invision:num:3.0.2")
```
