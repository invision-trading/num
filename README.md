...
[![Maven Central](https://img.shields.io/badge/Maven_Central-3.0.1-blue?logo=apachemaven)](https://central.sonatype.com/artifact/trade.invision/num)
...
```kotlin
implementation("trade.invision:num:3.0.1")
```
